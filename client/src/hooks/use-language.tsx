...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    "hero.badge": "قريباً في السعودية",
    "hero.headline1": "مرّ علينا.",
    "hero.headline2": "واحصل على مكافآت.",
    "hero.description": "حوّل زياراتك ولحظاتك الحقيقية إلى نقاط خبرة ومستويات ومكافآت تستحق.",
    "hero.earlyExplorers": "انضم إلى +2,000 مستكشف",
    "hero.noSpam": "بدون إزعاج، وعد.",
    "what.label": "فلسفتنا",
    "what.title": "أكثر من مجرد \"نقاط\"",
    "what.description": "\"ساير\" ليس مجرد اسم تطبيق. إنه دعوة. يعني \"تعال عندنا\" أو مر علينا. نؤمن أن حضورك مهم. نبني عالماً يصنع حضورك فيه قيمة—لك، ولأماكنك المفضلة، ولمجتمعك.",
    ...
    "form.success.title": "مرحباً بك في ساير!",
