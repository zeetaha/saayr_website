...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "how.step1.description": "Find hot spots near you. From cozy cafes to trendy restaurants in Riyadh.",
    ...
    "footer.copyright": "All rights reserved. Built with Chill in Riyadh.",
    "form.forYou": "For You",
  ...
  ar: {
    ...
    "how.step1.description": "اكتشف الأماكن الحماسية قريباً منك. من المقاهي الدافئة إلى المطاعم الترند في الرياض.",
